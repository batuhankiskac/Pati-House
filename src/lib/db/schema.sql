...
SELECT 'Hill', 'hill@example.com', '$2b$10$A5cKJ8VVaXsOwonlBtTMPuqm6hX4jcBpWJbtVPY05qtEH2gnnup..', 'Hill Administrator'
WHERE NOT EXISTS (SELECT 1 FROM users WHERE username = 'Hill');
